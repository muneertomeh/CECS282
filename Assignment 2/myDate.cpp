...
myDate::myDate(int M, int D, int Y) {
	...
	if (temp1 != M || temp2 != D || temp3 != Y ) {
		cout << "Incorrect date entry, all entered values have been set to the default date" << endl;
		month = 5;
		day = 11;
		year = 1959;
	}
...
void myDate::incrDate(int N) {
	...
	cout << "The original date has increased by " << N << " days" << endl;
...
void myDate::decrDate(int N) {
	...
	cout << "The original date has decreased by " << N << " days" << endl;
